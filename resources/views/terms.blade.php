...
@section('content')
    <section class="prose mx-auto py-8">
        ...
        <h2>3. Eligibility</h2>
        <p>You must be at least 18 years old and capable of entering into a binding agreement to use our services.</p>

        <h2>4. User Account</h2>
        <p>To access certain features, you must create an account. You agree to provide accurate information and to keep
            it
        ...
        <p>For paid plans, you agree to pay all applicable fees. Lifetime Access plans are non-refundable. All fees are
        ...
        <h2>8. Termination</h2>
        <p>We may terminate or suspend your account if you violate these terms. Upon termination, your right to use our
        ...
        <p>We may update these Terms of Use from time to time. We will notify you of any changes by posting the new
            terms on
            our site. Your continued use of our services constitutes acceptance of the updated terms.</p>
