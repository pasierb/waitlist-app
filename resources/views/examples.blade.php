...
<?php
    $examples = [
        ...
        [
            'imageUrl' => asset('img/examples/launchsoon.png'),
            'name' => 'LaunchSoon',
            'description' => 'Build waitlists that look like pages, not forms',
            'projectUrl' => 'https://getlaunchsoon.com/p/launchsoon/',
        ],
        [
            'imageUrl' => asset('img/examples/chromev2.png'),
            'name' => 'V2 Chrome Extension List',
            'description' => 'List of V2 Chrome extensions',
            'projectUrl' => 'https://getlaunchsoon.com/p/v2-chrome-extension-list-demo/',
        ]
    ]
?>
...
@section('content')
    <div class="bg-white">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            <h2 id="products-heading" class="text-center text-5xl font-semibold mb-12">Examples</h2>
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                ...
                <a href="{{ $example['projectUrl'] }}" target="_blank" class="group">
                    <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg sm:aspect-h-3 sm:aspect-w-2">
                        <img src="{{ $example['imageUrl'] }}" alt="Person using a pen to cross a task off a productivity paper card."
