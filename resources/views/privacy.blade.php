...
@section('content')
    <div class="prose mx-auto py-8">
        ...
        <ul>
            <li><strong>Personal Data</strong>: Name, email address, and other contact information.</li>
            <li><strong>Usage Data</strong>: Information about how you use our services, such as your IP address,
        ...
        <ul>
            ...
            <li><strong>Business Transfers</strong>: If we are involved in a merger, acquisition, or asset sale, your
